...
const FALLBACK_PRODUCTS: ProductSummary[] = [
  {
    ...
    description:
      "Sof 100% paxtadan ishlangan premium sifatli futbolka. Kundalik kiyish uchun juda qulay. Yozgi ob-havoda terlatmaydi va rangi uzoq cho'milishlarga chidamli.",
    variants: [
  ...
  },
  {
    ...
    category: "Ayollar",
    image:
      "https://images.unsplash.com/photo-1515347619362-e6fd1b82fb1a?auto=format&fit=crop&w=500&q=80",
    images: [
      "https://images.unsplash.com/photo-1515347619362-e6fd1b82fb1a?auto=format&fit=crop&w=500&q=80",
    ],
    description:
      "Issiq yoz kunlarida sizga nafislik ulashuvchi yengil paxtali ayollar ko'ylagi.",
  ...
  },
  {
    ...
    description:
      "Zamon bilan hamnafas ko'rinish. Bardoshli va aql bovar qilmas darajada qulay sport poyabzali.",
    variants: [
  ...
  },
  {
    ...
    category: "Bolalar",
    image:
      "https://images.unsplash.com/photo-1519241047957-be31d7379a5d?auto=format&fit=crop&w=500&q=80",
    images: [
      "https://images.unsplash.com/photo-1519241047957-be31d7379a5d?auto=format&fit=crop&w=500&q=80",
    ],
  ...
  },
  {
    ...
    description:
      "Quyosh nuridan himoyalovchi polarizatsiyalangan ko'zoynaklar.",
    variants: [],
    reviews: [],
  },
];
...
export async function getProducts(query: string = "") {
  try {
    ...
    const formattedDbProducts: ProductSummary[] = products.map((p) => ({
      id: p.id,
      title: p.title,
      price: p.price,
    ...
    let results: ProductSummary[] = formattedDbProducts;

    // Use mock products if DB is completely empty
    if (products.length === 0) {
      if (query) {
        results = FALLBACK_PRODUCTS.filter(
          (p) =>
...
export async function getProductById(id: string) {
  ...
  // Fallback if not found in DB or DB errors
